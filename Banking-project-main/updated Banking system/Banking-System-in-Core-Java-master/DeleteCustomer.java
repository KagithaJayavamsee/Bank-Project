...
public class DeleteCustomer extends JInternalFrame implements ActionListener {
	...
	void showRec (int intRec) {
		...
		// show last stored transaction and also show closing date (today)
		String lastTrans = records[intRec][2] + ", " + records[intRec][3] + ", " + records[intRec][4];
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		String closing = sdf.format(new Date());
		txtDate.setText(lastTrans + "  |  Closing on: " + closing);
